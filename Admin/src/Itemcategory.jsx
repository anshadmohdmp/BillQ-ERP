...
const Itemcategory = () => {
  ...
  const [FetchedItemcategorys, setFetchedItemcategorys] = useState([]);
  ...
  const SubmitData = async (e) => {
    ...
    headers: {
      ...
      setError("An error occurred while adding the Itemcategory.");
    }
  };
  ...
  // Edit
  const confirmEditItemcategory = (id) => {
  ...
  const handleEdit = () => {
    ...
    navigate(`/editItemcategory/${selectedItemcategoryId}`);
  };

  // Delete
  const confirmDeleteItemcategory = (id) => {
    setSelectedItemcategoryId(id);
  ...
  const handleDelete = async () => {
    ...
    headers: {
      ...
      console.error("❌ There was an error!", error);
      alert("An error occurred while deleting the Itemcategory.");
    }
  };
    ...
    >
        ...
        <div style={{ overflowX: "auto" }}>
          ...
          >
            <thead>
              <tr>
                <th>#</th>
                <th style={{ width: "600px" }}>Itemcategorys</th>
                <th></th>
              </tr>
            </thead>
            <tbody>
              {FetchedItemcategorys.length > 0 ? (
                FetchedItemcategorys.map((Itemcategory, index) => (
                  <tr key={Itemcategory._id}>
                    <td>{index + 1}</td>
                    <td>{Itemcategory.Itemcategory}</td>
                    <td style={{ textAlign: "center" }}>
                      <MdOutlineEdit
                        onClick={() => confirmEditItemcategory(Itemcategory._id)}
                        style={{ marginRight: "10px", cursor: "pointer" }}
                      />
                      <MdDeleteOutline
                        onClick={() => confirmDeleteItemcategory(Itemcategory._id)}
      ...
      <Modal show={showEditConfirm} onHide={() => setShowEditConfirm(false)} centered>
        ...
        >
          ...
          <p style={{ color: "#ccc" }}>Are you sure you want to edit this Itemcategory?</p>
      ...
      <Modal show={showDeleteConfirm} onHide={() => setShowDeleteConfirm(false)} centered>
        ...
        >
          ...
          <p style={{ color: "#ccc" }}>Are you sure you want to delete this Itemcategory?</p>
          <div style={{ display: "flex", justifyContent: "center", gap: "20px", marginTop: "15px" }}>
            <Button
              variant="secondary"
      ...
      <Modal show={showSuccessModal} onHide={() => setShowSuccessModal(false)} centered>
        ...
        >
          <h4 style={{ color: "#ffffffff", marginBottom: "10px" }}> Itemcategory Added Successfully</h4>
          <p style={{ color: "#ccc" }}>Your new Itemcategory has been saved successfully.</p>
          <Button
