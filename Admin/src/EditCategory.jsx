...
const EditCategory = () => {
  ...
  const SubmitData = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:3002/categories/${id}`, { CategoryName });
  ...
  const handleCloseModal = () => {
    ...
    navigate("/addcategory"); // Redirect after closing modal
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form onSubmit={SubmitData}>
          <Form.Group className="mb-4">
            <Form.Label style={{ fontWeight: "500", color: "#bdbdbd" }}>Category Name</Form.Label>
            <Form.Control
              type="text"
              value={CategoryName}
      ...
      <Modal show={showSuccessModal} onHide={handleCloseModal} centered>
        ...
        >
          <h4>✅ Category Edited Successfully</h4>
