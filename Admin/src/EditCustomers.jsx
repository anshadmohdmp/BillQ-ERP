...
const EditCustomers = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:3002/Customers/${id}`)
      .then((response) => {
  ...
  const SubmitData = async (e) => {
    ...
    try {
      await axios.put(`http://localhost:3002/Customers/${id}`, {
        CustomerName,
        CustomerAddress,
        CustomerNumber,
      });
  ...
  const handleCloseModal = () => {
    ...
    navigate("/Customers"); // Redirect after closing modal
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Form onSubmit={SubmitData}>
          <Form.Group className="mb-4">
            <Form.Label style={{ fontWeight: "500", color: "#bdbdbd" }}>Customer Name</Form.Label>
            <Form.Control
              type="text"
              value={CustomerName}
          ...
          <Form.Group className="mb-4">
            <Form.Label style={{ fontWeight: "500", color: "#bdbdbd" }}>Customer Address</Form.Label>
            <Form.Control
              type="text"
          ...
          <Form.Group className="mb-4">
            <Form.Label style={{ fontWeight: "500", color: "#bdbdbd" }}>Customer Number</Form.Label>
            <Form.Control
              type="number"
      ...
      <Modal show={showSuccessModal} onHide={handleCloseModal} centered>
        <Modal.Body
          style={{ background: "#272727ff", color: "white", textAlign: "center", padding: "25px" }}
        >
          <h4>✅ Customer Updated Successfully</h4>
